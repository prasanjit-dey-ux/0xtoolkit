...
export const PolarCard = () => {
      return <div className='flex justify-center items-center grid-col-2 size-60 px-2 bg-white border border-neutral-200 overflow-hidden'>
        <div className='border border-neutral-200 w-full h-60 p-2'>
                  <div className='border border-neutral-200 bg-blue-50 w-full h-60 p-2'>
                  <div className='border border-neutral-200 bg-blue-50 w-full h-60 p-2'>
                  <div className='border border-neutral-200 bg-blue-100 w-full h-60 p-2'>
                  <div className='border border-neutral-200 bg-blue-200 w-full h-60 p-2'>
                  <div className='border border-neutral-200 bg-blue-300 w-full h-60 p-2'>
                  <div className='border border-neutral-200 bg-blue-400 w-full h-60 p-2'>
                  <div className='border border-neutral-200 bg-blue-500 w-full h-60 p-2'>
                  <div className='border border-neutral-200 bg-blue-600 w-full h-60 p-2'>
                  <div className='border border-neutral-200 bg-blue-700 w-full h-60 p-2'>
                  <div className='border border-neutral-200 bg-blue-800 w-full h-60 p-2'>
                  <div className='border border-neutral-200 bg-blue-900 w-full h-60 p-2'>
